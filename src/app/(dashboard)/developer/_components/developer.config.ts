...
export const experienceByCompanyChartData = [
  { company: "eduzell", experience: 3, fill: "var(--color-eduzell)" },
  { company: "assuretech", experience: 24, fill: "var(--color-assuretech)" },
  // { company: "amazon", experience: 3, fill: "var(--color-social)" },
  // { company: "google", experience: 62, fill: "var(--color-cold)" },
  // { company: "tower", experience: 48, fill: "var(--color-other)" },
];

export const experienceByCompanyChartConfig = {
  experience: {
    label: "Experience",
  },
  eduzell: {
    label: "Eduzell Technologies",
    color: "var(--chart-1)",
  },
  assuretech: {
    label: "Assuretech Private Ltd.",
    color: "var(--chart-2)",
  },
  // amazon: {
  //   label: "Amazon Web Solutions",
